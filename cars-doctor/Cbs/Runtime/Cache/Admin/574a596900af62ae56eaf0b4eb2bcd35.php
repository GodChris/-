...
<head>
    ...
    <title>智谷科技后台管理框架 - WPP - 首页示例三</title>
    ...
    <!-- Morris -->
    <link href="/cbs-style/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
<body class="gray-bg sidebar-content">
        ...
        <div>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/cbs-style/img/a1.jpg">
                </a>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/cbs-style/img/a2.jpg">
                </a>
                <div class="media-body">
                    V信已经提前恢复，也算是个好消息吧
                    <br>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/cbs-style/img/a3.jpg">
                </a>
                <div class="media-body">
                    是你对不对
                    <br>
    ...
    <!-- Flot -->
    <script src="/cbs-style/js/plugins/flot/jquery.flot.js"></script>
    <script src="/cbs-style/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/cbs-style/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/cbs-style/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/cbs-style/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/cbs-style/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="/cbs-style/js/plugins/flot/curvedLines.js"></script>

    <!-- Peity -->
    <script src="/cbs-style/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/cbs-style/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="/cbs-style/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="/cbs-style/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/cbs-style/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="/cbs-style/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="/cbs-style/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/cbs-style/js/demo/sparkline-demo.js"></script>
