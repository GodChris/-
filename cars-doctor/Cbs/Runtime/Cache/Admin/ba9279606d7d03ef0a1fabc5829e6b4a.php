...
<head>
    ...
    <title>智谷科技后台管理框架 - WPP - 主页示例</title>
...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-3">
            <h2>你好,小伙伴们</h2>
            <small>欢迎来到智谷科技的管理后台：</small>
            <br>
            <br>
            <img src="/cbs-style/img/team.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
            ...
            <p>WPP是一个完全响应式，基于Bootstrap3.3.6最新版本开发的扁平化主题，她采用了主流的左右两栏式布局，使用了Html5+CSS3等现代技术，她提供了诸多的强大的可以重新组合的UI组件，并集成了最新的jQuery版本(v2.1.4)，当然，也集成了很多功能强大，用途广泛的jQuery插件，她可以用于所有的Web应用程序，如<b>网站管理后台</b>，<b>网站会员中心</b>，<b>CMS</b>，<b>CRM</b>，<b>OA</b>等等，当然，您也可以对她进行深度定制，以做出更强系统。</p>
            <p>
                <b>当前版本：</b>v3.2.2
            </p>
            <br>
            <p>
                <a class="btn btn-success btn-outline" href="http://wpa.qq.com/msgrd?v=3&uin=414954118&site=qq&menu=yes" target="_blank">
                    <i class="fa fa-qq"> </i> 联系我
                </a>
                <a class="btn btn-white btn-bitbucket" href="http://www.wisvalley.com" target="_blank">
                    <i class="fa fa-home"></i> 访问网站
                </a>
            </p>
        </div>
        <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <p><i class="fa fa-send-o"></i> 网站：<a href="http://www.wisvalley.com" target="_blank">http://www.wisvalley.com</a>
                        </p>
                        <p><i class="fa fa-qq"></i> QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=414954118&site=qq&menu=yes" target="_blank">414954118</a>
                        </p>
                        <p><i class="fa fa-weixin"></i> 微信：<a href="javascript:;">wis_li</a>
                        </p>
                        <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">414954118@qq.com</a>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="version">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v41">v3.2.2</a><code class="pull-right">2016.5.18</code>
                                            </h5>
                                    </div>
                                    <div id="v41" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <div class="alert alert-warning">此版本是一个维护版本，主要是升级和修复bug</div>
                                            <ol>
                                                <li>增加不支持IE8的页面提示</li>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v40">v3.2.1</a><code class="pull-right">2016.1.25</code>
                                            </h5>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v32">v3.2.0</a><code class="pull-right">2015.10.22</code>
                                            </h5>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#version" href="#v301">v3.0.1</a><code class="pull-right">2015.09.04</code>
                                            </h5>
                                    </div>
                                    <div id="v301" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <p>自WPP v3.0版发布后，又陆续发布了7个小版本，修复了一些兼容性问题，但是没有对外发布，更新日志略过……</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v18">v2.2.0</a><code class="pull-right">2015.02.23</code>
                                            </h5>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v17">v2.1.3</a><code class="pull-right">2015.02.11</code>
                                            </h5>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v16">v2.1.2</a><code class="pull-right">2014.01.26</code>
                                            </h5>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v15">v2.1.1</a><code class="pull-right">2014.01.17</code>
                                            </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#version" href="#v14">v2.1.0</a><code class="pull-right">2015.01.05</code>
                                            </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v11">v1.1.0</a><code class="pull-right">2014.9.10</code>
                                            </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#version" href="#v11">v1.0.0</a><code class="pull-right">2014.8.23</code>
                                            </h4>
                                    </div>
                                    <div id="v11" class="panel-collapse collapse">
                                        <div class="panel-body">
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <hr>
                        <p>本系统权限于江西智谷科技有限公司内部开发使用，任何人在未经公司许可的情况下，不得向外部泄露或另作它用！</p>
    ...
    <script id="welcome-template" type="text/x-handlebars-template">
        <div class="border-bottom white-bg page-heading clearfix">
            <h2>更新日志：</h2>
            <div>感谢小伙伴们不离不弃，一路相伴！</div>
            <div class="pull-right">——demos / 2016.5.20</div>
        </div>
        <div class="m">
    ...
    <!-- 自定义js -->
    <script src="/cbs-style/js/content.js"></script>

    <!-- 欢迎信息 -->
    <script src="/cbs-style/js/welcome.js"></script>
</body>
