            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>服务商信息 </h5>
                        <button type="button" id="change_info" name="change_info" onclick="window.location.href='#'" >修改信息</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <tr class="gradeX">
                                    ...
                                    <td>王凯</td>
                                    <td class="center">18279725966</td>
                                    <td class="center">E 42°</td>
									<td class="center">N 49°</td>
									<td>江西</td>
									<td>南昌</td>
									<td>良好</td>
                                </tr>
