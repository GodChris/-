...
<head>
    ...
    <title>智谷科技后台管理框架 - WPP - 首页示例四</title>
...
<body class="gray-bg top-navigation">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="footer">
                <div class="pull-right">
                    By：<a href="http://www.wisvalley.com" target="_blank">demos's blog</a>
                </div>
                <div>
                    <strong>Copyright</strong> WPP &copy; 2014
                </div>
            </div>
    ...
    <!-- ChartJS-->
    <script src="/cbs-style/js/plugins/chartJs/Chart.min.js"></script>
