...
<head>
    ...
    <link href="/cbs-style/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/cbs-style/img/profile_small.jpg" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">陈观民</strong></span>
                    ...
                    <li>
                        <a class="J_menuItem" href="table_jqgrid.html"><i class="fa fa-columns"></i> <span class="nav-label">技师管理</span></a>
                    </li>
					<li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">订单管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="table_data_tables_new.html">新订单</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables_history.html">历史订单</a>
                            </li>

							 <li><a class="J_menuItem" href="index_v3.html">订单统计</a>
                            </li>
                        </ul>
                    </li>
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="contacts.html">用户信息</a>
                            </li>
                            <li><a class="J_menuItem" href="index_v2.html">用户留言评价</a>
                            </li>
                        </ul>
                    </li>
					<li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">车辆管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="table_data_tables.html">车型统计</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables.html">二手车行</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables.html">热门车型</a>
                            </li>
                        </ul>
                    </li>
					<li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">服务管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="table_data_tables.html">服务选项</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables.html">套餐管理</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables.html">商品管理</a>
                            </li>
                        </ul>
                    </li>
					<li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">4S店服务商管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="table_data_tables_providerinfo.html">服务商信息</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables_provider_order.html">服务商订单</a>
                            </li>
                            <li><a class="J_menuItem" href="table_data_tables_provider_evaluate.html">服务商评价</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/cbs-style/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/cbs-style/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
                        ...
                        <li class="hidden-xs">
                            <a href="index_v1.html" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 首页</a>
                        </li>
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2014-2015 <a href="http://www.wisvalley.com/" target="_blank">demos's blog</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/cbs-style/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/cbs-style/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/cbs-style/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/cbs-style/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/cbs-style/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/cbs-style/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
        ...
        <div class="small-chat-box fadeInRight animated">
            ...
            <div class="form-chat">
                <div class="input-group input-group-sm">
                    <input type="text" class="form-control" value="学海无"> <span class="input-group-btn"> <button
    ...
    <script src="/cbs-style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/cbs-style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/cbs-style/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="/cbs-style/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="/cbs-style/js/contabs.js"></script>

    <!-- 第三方插件 -->
    <script src="/cbs-style/js/plugins/pace/pace.min.js"></script>
