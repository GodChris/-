                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="gradeX">
                            ...
                            <td>8.2</td>
                            <td>999</td>
                            <td><input type="text" id="worker_name"  />
                                <input type="button"  value="选择技师" onclick="showModalDialogss()"/></td>
                        </tr>
                        <tr class="gradeC">
                            <td>2</td>
...
<script>
    ...
    function showModalDialogss() {
        document.getElementById("worker_name").value = window.open("table_data_tables_chooseworkers.html", "_blank", "status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=400, height=400");
    }
</script>
