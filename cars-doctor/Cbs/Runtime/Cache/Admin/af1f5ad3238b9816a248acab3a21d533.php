...
<head>
    ...
    <!-- Gritter -->
    <link href="/cbs-style/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/cbs-style/img/profile.jpg">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/cbs-style/img/a5.jpg">
                                    </a>
                                    <div class="media-body ">
    ...
    <!-- GITTER -->
    <script src="/cbs-style/js/plugins/gritter/jquery.gritter.min.js"></script>
